% My VIM Cheat Sheet
% Author: Mark Hary (markhary.github.io)
% Last Edit: 2011-11-30
%
% DISCLAIMER: This work is licensed under a Creative Commons Attribution-NonCommercial-ShareAlike 3.0 Unported License (http://creativecommons.org/licenses/by-nc-sa/3.0/). The cheatsheet template was adapted from Lance Lafontaine's version found at https://github.com/lancelafontaine/vim-cheatsheet. This cheatsheet is intended for non-commercial use.
...
\verb! !\\
\verb!"+y! \hfill Copy to clipboard.\\
\verb!"+p! \hfill Paste to navigation.\\

\section{Defined in my .vimrc}
\verb!,Ctrl-n! \hfill Toggle NERDTree.\\
